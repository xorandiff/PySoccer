...
KICK_MIN_DISTANCE_VALUE = 20  # Minimal distance from player to the ball allowed to perform a kick
...
GK_LEFT_STARTPOS = (GOAL_POST_BORDER_GAP + GOAL_WIDTH + PLAYER_RADIUS + GK_STARTPOS_GOAL_GAP, SCREEN_HEIGHT / 2 - PLAYER_RADIUS)
GK_RIGHT_STARTPOS = (SCREEN_WIDTH - GOAL_POST_BORDER_GAP - GOAL_WIDTH - PLAYER_RADIUS - GK_STARTPOS_GOAL_GAP, SCREEN_HEIGHT / 2 - PLAYER_RADIUS)
